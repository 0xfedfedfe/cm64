...
const LevelScript level_ttc_entry[] = {
    INIT_LEVEL(),
    LOAD_RNC2(        /*seg*/ 0x07, _ttc_segment_7SegmentRomStart, _ttc_segment_7SegmentRomEnd),
    LOAD_RNC2_TEXTURE(/*seg*/ 0x09, _machine_rnc2SegmentRomStart, _machine_rnc2SegmentRomEnd),
