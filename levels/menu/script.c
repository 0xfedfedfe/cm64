...
const LevelScript level_main_menu_entry_1[] = {
    ...
    LOAD_RNC2(/*seg*/ 0x07, _menu_segment_7SegmentRomStart, _menu_segment_7SegmentRomEnd),
...
const LevelScript level_main_menu_entry_2[] = {
    ...
    /*10*/ LOAD_RNC2(/*seg*/ 0x07, _menu_segment_7SegmentRomStart, _menu_segment_7SegmentRomEnd),
    /*13*/ ALLOC_LEVEL_POOL(),
