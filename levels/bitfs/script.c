...
const LevelScript level_bitfs_entry[] = {
    INIT_LEVEL(),
    LOAD_RNC2(        /*seg*/ 0x07, _bitfs_segment_7SegmentRomStart, _bitfs_segment_7SegmentRomEnd),
    LOAD_RNC2_TEXTURE(/*seg*/ 0x09, _sky_rnc2SegmentRomStart, _sky_rnc2SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x0A, _bitfs_skybox_rnc2SegmentRomStart, _bitfs_skybox_rnc2SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x0B, _effect_rnc2SegmentRomStart, _effect_rnc2SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x05, _group2_rnc2SegmentRomStart, _group2_rnc2SegmentRomEnd),
    LOAD_RAW(         /*seg*/ 0x0C, _group2_geoSegmentRomStart, _group2_geoSegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x06, _group17_rnc2SegmentRomStart, _group17_rnc2SegmentRomEnd),
