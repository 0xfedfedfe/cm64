...
const LevelScript level_bbh_entry[] = {
    INIT_LEVEL(),
    LOAD_RNC2(        /*seg*/ 0x07, _bbh_segment_7SegmentRomStart, _bbh_segment_7SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x0A, _bbh_skybox_rnc2SegmentRomStart, _bbh_skybox_rnc2SegmentRomEnd),
    LOAD_RNC2_TEXTURE(/*seg*/ 0x09, _spooky_rnc2SegmentRomStart, _spooky_rnc2SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x05, _group9_rnc2SegmentRomStart, _group9_rnc2SegmentRomEnd),
