...
const LevelScript level_ssl_entry[] = {
    INIT_LEVEL(),
    LOAD_RNC2(        /*seg*/ 0x07, _ssl_segment_7SegmentRomStart, _ssl_segment_7SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x0A, _ssl_skybox_rnc2SegmentRomStart, _ssl_skybox_rnc2SegmentRomEnd),
    LOAD_RNC2_TEXTURE(/*seg*/ 0x09, _generic_rnc2SegmentRomStart, _generic_rnc2SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x05, _group5_rnc2SegmentRomStart, _group5_rnc2SegmentRomEnd),
