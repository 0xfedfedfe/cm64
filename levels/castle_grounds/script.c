...
const LevelScript level_castle_grounds_entry[] = {
    INIT_LEVEL(),
    LOAD_RNC2(        /*seg*/ 0x07, _castle_grounds_segment_7SegmentRomStart, _castle_grounds_segment_7SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x0A, _water_skybox_rnc2SegmentRomStart, _water_skybox_rnc2SegmentRomEnd),
    LOAD_RNC2_TEXTURE(/*seg*/ 0x09, _outside_rnc2SegmentRomStart, _outside_rnc2SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x05, _group10_rnc2SegmentRomStart, _group10_rnc2SegmentRomEnd),
    LOAD_RAW(         /*seg*/ 0x0C, _group10_geoSegmentRomStart,  _group10_geoSegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x06, _group15_rnc2SegmentRomStart, _group15_rnc2SegmentRomEnd),
