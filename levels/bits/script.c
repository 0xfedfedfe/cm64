...
const LevelScript level_bits_entry[] = {
    INIT_LEVEL(),
    LOAD_RNC2(        /*seg*/ 0x07, _bits_segment_7SegmentRomStart, _bits_segment_7SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x0A, _bits_skybox_rnc2SegmentRomStart, _bits_skybox_rnc2SegmentRomEnd),
