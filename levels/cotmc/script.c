...
const LevelScript level_cotmc_entry[] = {
    INIT_LEVEL(),
    LOAD_RNC2(        /*seg*/ 0x07, _cotmc_segment_7SegmentRomStart, _cotmc_segment_7SegmentRomEnd),
    LOAD_RNC2_TEXTURE(/*seg*/ 0x09, _cave_rnc2SegmentRomStart, _cave_rnc2SegmentRomEnd),
