...
const LevelScript level_bitdw_entry[] = {
    INIT_LEVEL(),
    LOAD_RNC2(        /*seg*/ 0x07, _bitdw_segment_7SegmentRomStart, _bitdw_segment_7SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x0A, _bidw_skybox_rnc2SegmentRomStart, _bidw_skybox_rnc2SegmentRomEnd),
    LOAD_RNC2_TEXTURE(/*seg*/ 0x09, _sky_rnc2SegmentRomStart, _sky_rnc2SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x05, _group11_rnc2SegmentRomStart, _group11_rnc2SegmentRomEnd),
