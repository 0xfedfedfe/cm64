...
const LevelScript level_totwc_entry[] = {
    INIT_LEVEL(),
    LOAD_RNC2(        /*seg*/ 0x07, _totwc_segment_7SegmentRomStart, _totwc_segment_7SegmentRomEnd),
    ...
    LOAD_RNC2(        /*seg*/ 0x05, _group8_rnc2SegmentRomStart, _group8_rnc2SegmentRomEnd),
