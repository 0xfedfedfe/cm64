...
const LevelScript level_lll_entry[] = {
    INIT_LEVEL(),
    LOAD_RNC2(        /*seg*/ 0x07, _lll_segment_7SegmentRomStart, _lll_segment_7SegmentRomEnd),
    LOAD_RNC2_TEXTURE(/*seg*/ 0x09, _fire_rnc2SegmentRomStart, _fire_rnc2SegmentRomEnd),
