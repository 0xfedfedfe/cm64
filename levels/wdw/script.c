...
const LevelScript level_wdw_entry[] = {
    INIT_LEVEL(),
    LOAD_RNC2(        /*seg*/ 0x07, _wdw_segment_7SegmentRomStart, _wdw_segment_7SegmentRomEnd),
    LOAD_RNC2_TEXTURE(/*seg*/ 0x09, _grass_rnc2SegmentRomStart, _grass_rnc2SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x0A, _wdw_skybox_rnc2SegmentRomStart, _wdw_skybox_rnc2SegmentRomEnd),
