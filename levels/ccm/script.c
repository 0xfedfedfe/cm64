...
const LevelScript level_ccm_entry[] = {
    INIT_LEVEL(),
    LOAD_RNC2(        /*seg*/ 0x07, _ccm_segment_7SegmentRomStart, _ccm_segment_7SegmentRomEnd),
    LOAD_RNC2_TEXTURE(/*seg*/ 0x09, _snow_rnc2SegmentRomStart, _snow_rnc2SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x0B, _effect_rnc2SegmentRomStart, _effect_rnc2SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x0A, _ccm_skybox_rnc2SegmentRomStart, _ccm_skybox_rnc2SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x05, _group7_rnc2SegmentRomStart, _group7_rnc2SegmentRomEnd),
    LOAD_RAW(         /*seg*/ 0x0C, _group7_geoSegmentRomStart,  _group7_geoSegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x06, _group16_rnc2SegmentRomStart, _group16_rnc2SegmentRomEnd),
