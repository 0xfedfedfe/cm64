...
const LevelScript level_jrb_entry[] = {
    INIT_LEVEL(),
    LOAD_RNC2(        /*seg*/ 0x07, _jrb_segment_7SegmentRomStart, _jrb_segment_7SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x0B, _effect_rnc2SegmentRomStart, _effect_rnc2SegmentRomEnd),
    LOAD_RNC2_TEXTURE(/*seg*/ 0x09, _water_rnc2SegmentRomStart, _water_rnc2SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x0A, _clouds_skybox_rnc2SegmentRomStart, _clouds_skybox_rnc2SegmentRomEnd),
