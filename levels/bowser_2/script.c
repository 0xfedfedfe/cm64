...
const LevelScript level_bowser_2_entry[] = {
    ...
    LOAD_RNC2(        /*seg*/ 0x07, _bowser_2_segment_7SegmentRomStart, _bowser_2_segment_7SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x06, _group12_rnc2SegmentRomStart, _group12_rnc2SegmentRomEnd),
