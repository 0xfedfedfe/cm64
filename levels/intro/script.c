...
const LevelScript level_intro_splash_screen[] = {
    ...
    LOAD_RNC2(/*seg*/ 0x07, _intro_segment_7SegmentRomStart, _intro_segment_7SegmentRomEnd),
...
const LevelScript level_intro_mario_head_regular[] = {
    ...
    LOAD_RAW(/*seg*/ 0x13, _behaviorSegmentRomStart, _behaviorSegmentRomEnd),
    LOAD_RNC2_TEXTURE(/*seg*/ 0x0A, _title_screen_bg_rnc2SegmentRomStart, _title_screen_bg_rnc2SegmentRomEnd),
...
const LevelScript level_intro_entry_4[] = {
    ...
    LOAD_RAW(/*seg*/ 0x13, _behaviorSegmentRomStart, _behaviorSegmentRomEnd),
    LOAD_RNC2_TEXTURE(/*seg*/ 0x0A, _title_screen_bg_rnc2SegmentRomStart, _title_screen_bg_rnc2SegmentRomEnd),
    LOAD_RNC2(/*seg*/ 0x07, _debug_level_select_rnc2SegmentRomStart, _debug_level_select_rnc2SegmentRomEnd),
    FIXED_LOAD(/*loadAddr*/ _goddardSegmentStart, /*romStart*/ _goddardSegmentRomStart, /*romEnd*/ _goddardSegmentRomEnd),
    ALLOC_LEVEL_POOL(),
