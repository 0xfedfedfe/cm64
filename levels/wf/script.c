...
const LevelScript level_wf_entry[] = {
    INIT_LEVEL(),
    LOAD_RNC2(        /*seg*/ 0x07, _wf_segment_7SegmentRomStart, _wf_segment_7SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x0A, _cloud_floor_skybox_rnc2SegmentRomStart, _cloud_floor_skybox_rnc2SegmentRomEnd),
    LOAD_RNC2_TEXTURE(/*seg*/ 0x09, _grass_rnc2SegmentRomStart, _grass_rnc2SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x05, _group1_rnc2SegmentRomStart, _group1_rnc2SegmentRomEnd),
    LOAD_RAW(         /*seg*/ 0x0C, _group1_geoSegmentRomStart,  _group1_geoSegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x06, _group14_rnc2SegmentRomStart, _group14_rnc2SegmentRomEnd),
