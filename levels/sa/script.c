...
const LevelScript level_sa_entry[] = {
    INIT_LEVEL(),
    LOAD_RNC2(        /*seg*/ 0x07, _sa_segment_7SegmentRomStart, _sa_segment_7SegmentRomEnd),
    LOAD_RNC2_TEXTURE(/*seg*/ 0x09, _inside_rnc2SegmentRomStart, _inside_rnc2SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x0A, _cloud_floor_skybox_rnc2SegmentRomStart, _cloud_floor_skybox_rnc2SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x0B, _effect_rnc2SegmentRomStart, _effect_rnc2SegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x05, _group4_rnc2SegmentRomStart, _group4_rnc2SegmentRomEnd),
    LOAD_RAW(         /*seg*/ 0x0C, _group4_geoSegmentRomStart,  _group4_geoSegmentRomEnd),
    LOAD_RNC2(        /*seg*/ 0x06, _group13_rnc2SegmentRomStart, _group13_rnc2SegmentRomEnd),
